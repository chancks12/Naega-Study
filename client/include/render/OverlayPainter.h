...
private:
    ...
    void draw_bar(ID2D1RenderTarget* rt, float x, float y, float w, float h,
                  float ratio, ID2D1SolidColorBrush* fill, ID2D1SolidColorBrush* bg);
    void draw_text(ID2D1RenderTarget* rt, const std::wstring& text,
                   float x, float y, float w, float h,
                   IDWriteTextFormat* fmt, ID2D1SolidColorBrush* brush);
    void draw_dot(ID2D1RenderTarget* rt, float cx, float cy, float r,
    ...
    Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> brush_toast_bg_;
    Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> brush_timer_bg_;
    Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> brush_calib_bg_;
    Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> brush_calib_panel_;
    Microsoft::WRL::ComPtr<IDWriteTextFormat>     fmt_calib_count_;
    Microsoft::WRL::ComPtr<IDWriteTextFormat>     fmt_calib_msg_;

    Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> brush_chart_line_;
    Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> brush_chart_bg_;
